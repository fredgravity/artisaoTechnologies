    ...
    <div id="home" class="show-body">
      <section id="demo-section">
        <div class="demo-container">
          ...
          <!-- </video> -->
          <iframe  src="https://youtube.com/embed/ysk5qQjGs_8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </section>
        ...
        <div class="container reveal">
          <div class="text-card">
            ...
            <div class="text-details">
              <h4><span class="second-text">Type:</span> Desktop Application</h4>
              <h4><span class="second-text">Setup:</span>Offline</h5>
              <h4><span class="second-text">Category:</span> School Management Sys</h5>
            ...
            <p>
              ...
              <li>Fees Payment Record</li>
              <li>Admin Dashboard</li>
              <li>Search Students and Teachers</li>
              <li>Remove Students and Teachers</li>
              <li>Students Test Grading</li>
